...
class MixedGroupExtension extends Autodesk.Viewing.Extension {
    ...
    _updatePointCloudGeometry( messages, i ) {
        ...
        for ( let index = 0; index < group.children.length; index++ ) { 
            ...
            else if ( ( m!= undefined ) && ( m.prev_type == -200 || m.prev_type == -800) && ( m.type != m.prev_type ) ) {
            ...
            else if ( ( m!= undefined ) && (m.type != -200) && ( m.state != m.previous_state) && ( particles.geometry.type == "BufferGeometry" ) ){
                // console.log(index)
                // debugger;
            ...
            // Edit virus particle characteristics
    ...
    onToolbarCreated() {
       var i;
        ...
        this._button = new Autodesk.Viewing.UI.Button('Reset All');
        this._button.onClick = (ev) => {

            // Why does it look weird when it resets?
            this.resetAll = true;
